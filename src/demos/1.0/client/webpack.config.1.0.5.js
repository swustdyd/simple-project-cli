...
const config = {
    ...
    module: {
        rules: [
            ...
            {
                test: /\.scss$/,
                use: isDev ? ['style-loader', 'happypack/loader?id=scss'] : ExtractTextPlugin.extract({
            ...
            {
                test: /\.css$/,
                use: isDev ? ['style-loader', 'css-loader', 'resolve-url-loader'] : ExtractTextPlugin.extract({
                    fallback: 'style-loader',
